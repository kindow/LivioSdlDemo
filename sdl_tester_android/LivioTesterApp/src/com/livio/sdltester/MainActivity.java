...
public class MainActivity extends Activity{
    ...
    private final ServiceConnection mConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
        	//要注意mConnection 是Activity和它绑定的service的连接器，而包含service的Messenger 则是Activity和车机应用 通讯的连接器
	...
	private void createAlertDialog(List<SdlImageItem> images){
		...
		alertDialog.setListener(singleMessageListener); //点OK触发 singleMessageListener
		alertDialog.show();
	}
